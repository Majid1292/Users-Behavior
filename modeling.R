...
library(gridExtra)
#####################################################################################
train <- read.csv('final_totalDay.csv', header = TRUE)
head(train)
names(train)
...
used_columns <- c( "resources_requested", "request_count", "days", "weight_request", "bandwidth")
...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
test <- read.csv('final_test_totalDay.csv', header = TRUE)
